...
import { LogOut, LayoutDashboard, FileCheck, UsersRound } from "lucide-react";
...
const navigation = [
  ...
  { name: "All Dealers", href: "/dealers", icon: UsersRound },
  { name: "Submission Forms", href: "/submission-forms", icon: FileCheck },
];
